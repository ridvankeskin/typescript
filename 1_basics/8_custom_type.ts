...
let user_1: { name: string; age: number } = { name: "batur", age: 45 };

let user_2: { name: string; age: number } = { name: "taha", age: 20 };

// çözüm sıklıkla kullanılan tipler için bir özel tip oluşturmak

type userType = { name: string; age: number };

let user_3: userType = { name: "batur", age: 45 };

let user_4: userType = { name: "taha", age: 20 };
